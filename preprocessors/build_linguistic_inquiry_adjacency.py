...
def build_linguistic_inquiry_adjacency(ds_name: str, cfg: PreProcessingConfigs, pl: PrintLog):
    ...
    create_dir(dir_path=cfg.corpus_shuffled_adjacency_dir +
               "/linguistic_inquiry", overwrite=False)
    ...
    with open(cfg.corpus_shuffled_adjacency_dir + "/linguistic_inquiry/ind.{}.adj".format(ds_name), 'wb') as f:
        pkl.dump(adj, f)
